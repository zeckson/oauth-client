        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('weboauthclientApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-weboauthclientApp-error');
                                var entityKey = httpResponse.headers('X-weboauthclientApp-params');
                                if (errorHeader) {
